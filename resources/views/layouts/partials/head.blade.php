...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/principal/img/logo/favicon.png') }}">

    <!-- CSS here -->
    <link rel="stylesheet" href="{{ asset('assets/principal/css/bootstrap.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/principal/css/animate.css') }}">
