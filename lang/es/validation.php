...
return [
    ...
    'attributes'           => [
        ...
        'water_baptism_date' => 'fecha de bautismo en agua',
        'es_baptism_date' => 'fecha de bautismo en el E.S.',
        'position_id' => 'cargo en la iglesia',
        'ministry' => 'ministerio',
        'phone' => 'teléfono / WhatsApp',
        'email' => 'correo electrónico',
        'church_id' => 'nombre de la iglesia',
        'member_id' => 'miembro',
    ],
];
